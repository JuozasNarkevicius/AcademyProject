  ...
  <Grid container spacing={{ xs: 1, md: 2 }} columns={{ xs: 2, md: 12 }}>
    ...
    <FadeInSection>
      <Grid
        ...
        xs={6}
        sx={{
          color: 'white', display: 'flex', justifyContent: 'center', alignItems: 'center', minHeight: '65rem',
        }}
      >
    ...
    <FadeInSection>
      <Grid
        ...
        xs={6}
        sx={{
          color: 'white', minHeight: '65rem', display: 'flex', justifyContent: 'center', alignItems: 'center', mt: '7rem',
        }}
      >
        <Typography sx={{ textAlign: 'left', fontSize: '35px', m: '13rem' }}>
